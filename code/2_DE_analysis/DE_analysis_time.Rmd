...
DE_genes_response1_mean <- sapply(c( "Day1", "Day3", "Day14"), function(day) rowMeans(assay(
DE_genes_response)[, which(colData(
DE_genes_response)$time == day & DE_genes_response$response == 1)]))

DE_genes_response2_mean <- sapply(c( "Day1", "Day3", "Day14"), function(day) rowMeans(assay(
DE_genes_response)[, which(colData(
...
pheatmap(DE_genes_response1_mean, cluster_rows = TRUE,  cluster_cols = FALSE, scale = "row", 
          main = "Heatmap on top 50 DE genes wrt response 1 over time by BH adjusted p-values")

pheatmap(DE_genes_response2_mean, cluster_rows = TRUE,  cluster_cols = FALSE, scale = "row", 
          main = "Heatmap on top 50 DE genes wrt response 2 over time by BH adjusted p-values")
